# 1 "c:\\project\\pvr\\scripts\\newscenarios\\report2_adhocreport\\\\combined_Report2_AdhocReport.c"
...
# 1 "c:\\project\\pvr\\scripts\\newscenarios\\report2_adhocreport\\\\combined_Report2_AdhocReport.c" 2
...
Action()
{
	...
	lr_end_transaction("Rep2_T01_OpenApplication",2);
	...
	web_url("{User_Id}", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1591785470190", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/dashboard/index", 
		"Snapshot=t49.inf", 
	...
	lr_end_transaction("Rep2_T02_Login",2);
	...
	web_url("{User_Id}_2", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1591785505754", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t95.inf", 
	...
	lr_end_transaction("Rep2_T03_NavigateAdhocReport_NewReport",2);
	...
	lr_end_transaction("Rep2_T04_ClickProductLookUp",2);

	lr_think_time(3);
	
	lr_start_transaction("Rep2_T05_SearchProduct");
	...
	lr_end_transaction("Rep2_T05_SearchProduct", 2);

	lr_think_time(3);
	
	lr_start_transaction("Rep2_T06_SelectProduct");

	lr_end_transaction("Rep2_T06_SelectProduct",2);
	...
	web_url("getTemplateList", 
		"URL={URL}/reports/reportTemplateRest/getTemplateList?term=&page=1&max=30&oldSelectedValue=&_=1591785505755", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t118.inf", 
	...
	web_url("getTemplateList_2", 
		"URL={URL}/reports/reportTemplateRest/getTemplateList?term=Case+Line+Listing+(Study)&page=1&max=30&oldSelectedValue=&_=1591785505756", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t119.inf", 
	...
	web_url("customSQLValuesForTemplate", 
		"URL={URL}/reports/template/customSQLValuesForTemplate?templateId={CaseLineListStudy_Temp}&_=1591785505757", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t120.inf", 
	...
	web_url("poiInputsForTemplate", 
		"URL={URL}/reports/template/poiInputsForTemplate?templateId={CaseLineListStudy_Temp}&_=1591785505758", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t121.inf", 
	...
	web_url("keep-alive", 
		"URL={URL}/reports/keep-alive?_=1591785505759", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t122.inf", 
	...
	web_url("keep-alive_2", 
		"URL={URL}/reports/keep-alive?_=1591785505760", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t124.inf", 
	...
	web_url("keep-alive_3", 
		"URL={URL}/reports/keep-alive?_=1591785505761", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t125.inf", 
	...
	lr_end_transaction("Rep2_T07_SelectReportTemplate",2);

	lr_think_time(3);

	web_url("keep-alive_4", 
		"URL={URL}/reports/keep-alive?_=1591785505762", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t126.inf", 
	...
	web_submit_data("run",
		...
		"Name=templateQueries[0].template", "Value={CaseLineListStudy_Temp}", "ENDITEM",
		...
		"Name=schedulerTime", "Value={Scheduler_Date} {Schedler_Time1}", "ENDITEM",
		"Name=scheduleDateJSON", "Value={\"startDateTime\":\"{Scheduler_Date}T{Scheduler_Time2}Z\",\"timeZone\":{\"text\":\"(GMT +00:00) UTC\\n"
	...
	web_url("{User_Id}_3", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1591785796544", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/executionStatus/list", 
		"Snapshot=t138.inf", 
	...
	lr_end_transaction("Rep2_T08_SaveAndRun",2);
	...
	lr_end_transaction("Rep2_T09_Logout",2);
