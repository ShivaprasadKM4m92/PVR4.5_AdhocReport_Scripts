Action()
{
	...
	lr_start_transaction("Rep7_T01_OpenApplication");
...
/*Correlation comment - Do not change!  Original value='45c442a9-5f9d-470e-8bdc-947d2240ac7a' Name ='CsrfTokenId1' Type ='Manual'*/
	...
	lr_end_transaction("Rep7_T01_OpenApplication",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep7_T02_Login");
...
/*Correlation comment - Do not change!  Original value='1a6c4f0b-06b4-4696-81f6-6ea3dd9a9665' Name ='CsrfTokeId2' Type ='Manual'*/
	web_reg_save_param_ex(
		"ParamName=CsrfTokeId2",
		"LB= content=\"",
		"RB=\"/>\n        ",
		SEARCH_FILTERS,
		"Scope=Body",
...
//		"style");
	...
	web_url("{User_Id}", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1592300616197", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/dashboard/index", 
		"Snapshot=t49.inf", 
...
//		"{URL}");
	...
	web_url("websocket", 
		"URL={URL}/reports/stomp/149/hbdfq11r/websocket", 
		"Resource=0", 
		"Referer=", 
		"Snapshot=t56.inf", 
		"Mode=HTTP", 
	...
	lr_end_transaction("Rep7_T02_Login",LR_AUTO);
	...
	lr_start_transaction("Rep7_T03_NavigateAdhocReport_NewReport");
...
//		"*/*");
	...
	web_url("{User_Id}_2", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1592300645695", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t100.inf", 
...
//
//	web_url("websocket_2", 
//		"URL={URL}/reports/stomp/535/pdc_23hf/websocket", 
//		"Resource=0", 
//		"Referer=", 
//		"Snapshot=t110.inf", 
//		"Mode=HTTP", 
//		LAST);
	...
	lr_end_transaction("Rep7_T03_NavigateAdhocReport_NewReport",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep7_T04_ClickProductLookUp");

	lr_end_transaction("Rep7_T04_ClickProductLookUp",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep7_T05_SearchProduct");
	...
	lr_end_transaction("Rep7_T05_SearchProduct",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep7_T06_SelectProduct");
	...
	lr_end_transaction("Rep7_T06_SelectProduct",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep7_T07_SelectReportTemplate");
	...
	web_url("getTemplateList", 
		"URL={URL}/reports/reportTemplateRest/getTemplateList?term=&page=1&max=30&oldSelectedValue=&_=1592300645697", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t122.inf", 
	...
	web_url("getTemplateList_2", 
		"URL={URL}/reports/reportTemplateRest/getTemplateList?term=AE+by+SOC&page=1&max=30&oldSelectedValue=&_=1592300645698", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t123.inf", 
	...
	web_url("customSQLValuesForTemplate", 
		"URL={URL}/reports/template/customSQLValuesForTemplate?templateId={TemplateId}&_=1592300645699", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t124.inf", 
	...
	web_url("poiInputsForTemplate", 
		"URL={URL}/reports/template/poiInputsForTemplate?templateId={TemplateId}&_=1592300645700", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t125.inf", 
	...
	lr_end_transaction("Rep7_T07_SelectReportTemplate",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep7_T08_SelectReportQuery");

	web_url("getQueryList", 
		"URL={URL}/reports/queryRest/getQueryList?isQueryTargetReports=true&term=&page=1&max=30&oldSelectedValue=&_=1592300645701", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t126.inf", 
	...
	web_url("getQueryList_2", 
		"URL={URL}/reports/queryRest/getQueryList?isQueryTargetReports=true&term=Medication+Errors&page=1&max=30&oldSelectedValue=&_=1592300645702", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t127.inf", 
	...
	web_url("queryExpressionValuesForQuery", 
		"URL={URL}/reports/query/queryExpressionValuesForQuery?queryId={QueryId}&_=1592300645703", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t128.inf", 
	...
	web_url("customSQLValuesForQuery", 
		"URL={URL}/reports/query/customSQLValuesForQuery?queryId={QueryId}&_=1592300645704", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t129.inf", 
	...
	web_url("queryExpressionValuesForQuerySet", 
		"URL={URL}/reports/query/queryExpressionValuesForQuerySet?queryId={QueryId}&_=1592300645705", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t130.inf", 
	...
	web_url("reportFieldsForQueryValue", 
		"URL={URL}/reports/queryRest/reportFieldsForQueryValue?name=masterPbrerBucket&_=1592300645706", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t131.inf", 
	...
	web_url("possibleValues", 
		"URL={URL}/reports/query/possibleValues?lang=en&field=masterPbrerBucket&_=1592300645707", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t132.inf", 
	...
	web_url("possibleValues_2", 
		"URL={URL}/reports/query/possibleValues?lang=en&field=masterPbrerBucket&_=1592300645708", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t133.inf", 
	...
	lr_end_transaction("Rep7_T08_SelectReportQuery",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep7_T09_SaveAndRun");
...
//		"Name=productSelection", "Value={\"1\":[{\"name\":\"{ProductName}\",\"id\":\"{ProductId}\"}],\"2\":[],\"3\":[],\"4\":[]}", ENDITEM,
		...
		"Name=templateQueries[0].dateRangeInformationForTemplateQuery.dateRangeStartAbsolute", "Value={DateRangeFrom}", ENDITEM,
		"Name=templateQueries[0].dateRangeInformationForTemplateQuery.dateRangeEndAbsolute", "Value={DateRangeTo}", ENDITEM,
		...
		"Name=_csrf", "Value={CsrfTokeId2}", ENDITEM,
		LAST);
	...
	web_url("{User_Id}_3", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1592300855093", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/executionStatus/list", 
		"Snapshot=t149.inf", 
	...
	lr_end_transaction("Rep7_T09_SaveAndRun",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep7_T10_Logout");
...
//	web_concurrent_end(NULL);
	...
	lr_end_transaction("Rep7_T10_Logout",LR_AUTO);
