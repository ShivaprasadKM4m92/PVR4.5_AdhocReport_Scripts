# 1 "c:\\project\\pvr\\scripts\\newscenarios\\report12_adhocreport\\\\combined_Report12_AdhocReport.c"
...
# 1 "c:\\project\\pvr\\scripts\\newscenarios\\report12_adhocreport\\\\combined_Report12_AdhocReport.c" 2
...
Action()
{
	...
	lr_end_transaction("Rep12_T01_OpenApplication",2);
	...
	lr_end_transaction("Rep12_T02_Login",2);
	...
	lr_end_transaction("Rep12_T03_NavigateAdhocReport_NewReport",2);

	lr_think_time(3);

	lr_start_transaction("Rep12_T04_ClickProductLookUp");

	lr_end_transaction("Rep12_T04_ClickProductLookUp",2);
	...
	lr_end_transaction("Rep12_T05_SearchProduct",2);
	...
	lr_end_transaction("Rep12_T06_SelectProduct",2);
	...
	lr_end_transaction("Rep12_T07_SelectReportTemplate",2);
	...
	lr_end_transaction("Rep12_T08_SaveAndRun",2);
	...
	lr_end_transaction("Rep12_T09_Logout",2);
