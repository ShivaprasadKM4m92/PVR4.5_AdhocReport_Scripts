Action()
{
	...
	lr_start_transaction("Rep12_T01_OpenApplication");
...
/*Correlation comment - Do not change!  Original value='e66fcf3e-001c-407a-a34f-338a8cb3f492' Name ='CsrfTokenId_1' Type ='Manual'*/
	...
	lr_end_transaction("Rep12_T01_OpenApplication",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep12_T02_Login");
...
//		"application/json, text/javascript, */*; q=0.01");
	...
	web_url("{User_Id}", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1591779457028", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/dashboard/index", 
		"Snapshot=t51.inf", 
...
//
//	web_url("websocket", 
//		"URL={URL}/reports/stomp/718/2jzjn0l0/websocket", 
//		"Resource=0", 
//		"Referer=", 
//		"Snapshot=t58.inf", 
//		"Mode=HTTP", 
//		LAST);
	...
	lr_end_transaction("Rep12_T02_Login",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep12_T03_NavigateAdhocReport_NewReport");
...
//		"XMLHttpRequest");
	...
	web_url("{User_Id}_2", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1591779480712", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t100.inf", 
...
//
//	web_url("websocket_2", 
//		"URL={URL}/reports/stomp/916/sp72e6p_/websocket", 
//		"Resource=0", 
//		"Referer=", 
//		"Snapshot=t113.inf", 
//		"Mode=HTTP", 
...
//		"script");
	...
	lr_end_transaction("Rep12_T03_NavigateAdhocReport_NewReport",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep12_T04_ClickProductLookUp");

	lr_end_transaction("Rep12_T04_ClickProductLookUp",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep12_T05_SearchProduct");
	...
	lr_end_transaction("Rep12_T05_SearchProduct",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep12_T06_SelectProduct");
...
//
//	web_url("keep-alive", 
//		"URL={URL}/reports/keep-alive?_=1591779480713", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/reports/configuration/create", 
//		"Snapshot=t121.inf", 
...
//		LAST);
	...
	lr_end_transaction("Rep12_T06_SelectProduct",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep12_T07_SelectReportTemplate");

	web_add_auto_header("Accept", 
		"application/json, text/javascript, */*; q=0.01");

	web_url("getTemplateList", 
		"URL={URL}/reports/reportTemplateRest/getTemplateList?term=&page=1&max=30&oldSelectedValue=&_=1591779480714", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t122.inf", 
	...
	web_url("getTemplateList_2", 
		"URL={URL}/reports/reportTemplateRest/getTemplateList?term=Case+Line+Listing+(Study)&page=1&max=30&oldSelectedValue=&_=1591779480715", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t123.inf", 
	...
	web_url("customSQLValuesForTemplate", 
		"URL={URL}/reports/template/customSQLValuesForTemplate?templateId={TempId}&_=1591779480716", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t124.inf", 
	...
	web_url("poiInputsForTemplate", 
		"URL={URL}/reports/template/poiInputsForTemplate?templateId={TempId}&_=1591779480717", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t125.inf", 
	...
	lr_end_transaction("Rep12_T07_SelectReportTemplate",LR_AUTO);
...
//		"URL={URL}/reports/keep-alive?_=1591779480718", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/reports/configuration/create", 
//		"Snapshot=t126.inf", 
...
//		LAST);
	...
	lr_start_transaction("Rep12_T08_SaveAndRun");

//	web_url("keep-alive_3", 
//		"URL={URL}/reports/keep-alive?_=1591779480719", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/reports/configuration/create", 
//		"Snapshot=t127.inf", 
...
//		LAST);
	...
	web_submit_data("run", 
		...
		"Name=templateQueries[0].template", "Value={TempId}", ENDITEM, 
		...
		"Name=schedulerTime", "Value={SchedulerDate} {SchedulerTime_1}", ENDITEM, 
		"Name=scheduleDateJSON", "Value={\"startDateTime\":\"{SchedulerDate}T{SchedulerTime_2}Z\",\"timeZone\":{\"text\":\"(GMT +00:00) UTC\\n                                \",\"selected\":true,\"offset\":\"+00:00\",\"name\":\"UTC\"},\"recurrencePattern\":\"FREQ=DAILY;INTERVAL=1;COUNT=1\"}", ENDITEM, 
	...
	web_url("{User_Id}", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1591958405251", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/executionStatus/list", 
		"Snapshot=t6.inf", 
	...
	web_url("executionStatus", 
		...
		"columns%5B10%5D%5Bsearch%5D%5Bregex%5D=false&order%5B0%5D%5Bcolumn%5D=5&order%5B0%5D%5Bdir%5D=desc&start=0&length=50&search%5Bvalue%5D=&search%5Bregex%5D=false&tableFilter=%7B%7D&advancedFilter=false&sharedwith=&searchString=&direction=desc&sort=runDate&status=GENERATING&_=1591958405252", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/executionStatus/list", 
		"Snapshot=t7.inf", 
	...
	lr_end_transaction("Rep12_T08_SaveAndRun",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep12_T09_Logout");
	...
	lr_end_transaction("Rep12_T09_Logout",LR_AUTO);
