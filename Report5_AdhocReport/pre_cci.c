# 1 "c:\\project\\pvr\\scripts\\newscenarios\\report5_adhocreport\\\\combined_Report5_AdhocReport.c"
...
# 1 "c:\\project\\pvr\\scripts\\newscenarios\\report5_adhocreport\\\\combined_Report5_AdhocReport.c" 2
...
Action()
{
	...
	lr_end_transaction("Rep5_T01_OpenApplication",2);
	...
	lr_end_transaction("Rep5_T02_Login",2);
	...
	lr_end_transaction("Rep5_T03_NavigateAdhocReport_NewReport",2);

	lr_think_time(3);

	lr_start_transaction("Rep5_T04_ClickProductLookUp");

	lr_end_transaction("Rep5_T04_ClickProductLookUp",2);
	...
	lr_end_transaction("Rep5_T05_SearchProduct",2);
	...
	lr_end_transaction("Rep5_T06_SelectProduct",2);
	...
	lr_end_transaction("Rep5_T07_SelectReportTemplate",2);
	...
	lr_end_transaction("Rep5_T08_SelectReportQuery",2);
	...
	lr_end_transaction("Rep5_T09_SelectDateRange(1Year)",2);
	...
	lr_end_transaction("Rep5_T10_SaveAndRun",2);
	...
	lr_end_transaction("Rep5_T11_Logout",2);

	lr_think_time(3);

	return 0;
}
# 5 "c:\\project\\pvr\\scripts\\newscenarios\\report5_adhocreport\\\\combined_Report5_AdhocReport.c" 2
