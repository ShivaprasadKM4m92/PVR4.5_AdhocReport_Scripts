...
/*Correlation comment - Do not change!  Original value='2fed9324-e590-4878-9188-13b3e6a9ff9d' Name ='CsrfId1' Type ='Manual'*/
...
/*Correlation comment - Do not change!  Original value='51f24efb-70fa-4fb9-9fd2-f30d6f010956' Name ='CsrfId2' Type ='Manual'*/
	web_reg_save_param_ex(
		"ParamName=CsrfId2",
		"LB= content=\"",
		"RB=\"/>\n        ",
	...
	web_submit_data("authenticate",
		...
		"Name=_csrf", "Value={CsrfId1}", ENDITEM,
		LAST);
...
//		"application/json, text/javascript, */*; q=0.01");
	...
	web_url("{User_Id}", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1591941742714", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/dashboard/index", 
		"Snapshot=t53.inf", 
...
//		"application/json, text/javascript, */*; q=0.01");
	...
	web_url("dataTables_en.json_2", 
		"URL={URL}/reports/assets/i18n/dataTables_en.json?_=1591941742715", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/dashboard/index", 
		"Snapshot=t57.inf", 
...
//
//	web_url("websocket", 
//		"URL={URL}/reports/stomp/662/o7z1nmz0/websocket", 
//		"Resource=0", 
//		"Referer=", 
//		"Snapshot=t58.inf", 
//		"Mode=HTTP", 
...
//		"application/json, text/javascript, */*; q=0.01");
	...
	web_url("{User_Id}_2", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1591941781550", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t99.inf", 
...
//		"*/*");
	...
	web_url("websocket_2", 
		"URL={URL}/reports/stomp/426/unvra634/websocket", 
		"Resource=0", 
		"Referer=", 
		"Snapshot=t116.inf", 
		"Mode=HTTP", 
	...
	web_custom_request("getSelectedItem", 
		"URL={URL}/reports/productDictionary/getSelectedItem?productId={ProdcutId}&dataSource=pva&dictionaryLevel=3&currentLang=en", 
		"Method=POST", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
	...
	web_submit_data("getPreLevelProductParents", 
		...
		"Name=productIds", "Value={ProdcutId}", ENDITEM, 
		LAST);
...
//
//	web_url("keep-alive", 
//		"URL={URL}/reports/keep-alive?_=1591941781551", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/reports/configuration/create", 
//		"Snapshot=t122.inf", 
...
//		LAST);
	...
	web_url("getTemplateList", 
		"URL={URL}/reports/reportTemplateRest/getTemplateList?term=&page=1&max=30&oldSelectedValue=&_=1591941781552", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t123.inf", 
	...
	web_url("getTemplateList_2", 
		"URL={URL}/reports/reportTemplateRest/getTemplateList?term=Case+Line+Listing+(Marketed)&page=1&max=30&oldSelectedValue=&_=1591941781553", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t124.inf", 
	...
	web_url("customSQLValuesForTemplate", 
		"URL={URL}/reports/template/customSQLValuesForTemplate?templateId={TemplateId}&_=1591941781554", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t125.inf", 
	...
	web_url("poiInputsForTemplate", 
		"URL={URL}/reports/template/poiInputsForTemplate?templateId={TemplateId}&_=1591941781555", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t126.inf", 
	...
	web_url("getQueryList", 
		"URL={URL}/reports/queryRest/getQueryList?isQueryTargetReports=true&term=&page=1&max=30&oldSelectedValue=&_=1591941781556", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t127.inf", 
	...
	web_url("getQueryList_2", 
		"URL={URL}/reports/queryRest/getQueryList?isQueryTargetReports=true&term=Medical+Condition+SMQ+(Broad)&page=1&max=30&oldSelectedValue=&_=1591941781557", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t128.inf", 
	...
	web_url("queryExpressionValuesForQuery", 
		"URL={URL}/reports/query/queryExpressionValuesForQuery?queryId={QueryId}&_=1591941781558", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t129.inf", 
	...
	web_url("customSQLValuesForQuery", 
		"URL={URL}/reports/query/customSQLValuesForQuery?queryId={QueryId}&_=1591941781559", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t130.inf", 
	...
	web_url("queryExpressionValuesForQuerySet", 
		"URL={URL}/reports/query/queryExpressionValuesForQuerySet?queryId={QueryId}&_=1591941781560", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t131.inf", 
	...
	web_url("reportFieldsForQueryValue", 
		"URL={URL}/reports/queryRest/reportFieldsForQueryValue?name=patCondSmqCasesBroadSmqParent&_=1591941781561", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t132.inf", 
	...
	web_url("reportFieldsForQueryValue_2", 
		"URL={URL}/reports/queryRest/reportFieldsForQueryValue?name=cpthConditionTypeId&_=1591941781562", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t133.inf", 
	...
	web_url("possibleValues", 
		"URL={URL}/reports/query/possibleValues?lang=en&field=cpthConditionTypeId&_=1591941781563", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t134.inf", 
	...
	web_url("possibleValues_2", 
		"URL={URL}/reports/query/possibleValues?lang=en&field=cpthConditionTypeId&_=1591941781564", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t135.inf", 
...
//		"URL={URL}/reports/keep-alive?_=1591941781565", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/reports/configuration/create", 
//		"Snapshot=t136.inf", 
...
//		"URL={URL}/reports/keep-alive?_=1591941781566", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/reports/configuration/create", 
//		"Snapshot=t138.inf", 
...
//		LAST);
	...
	web_submit_data("run",
		...
		"Name=productSelection", "Value={\"1\":[],\"2\":[],\"3\":[{\"name\":\"{ProductName}\",\"id\":\"{ProdcutId}\"}],\"4\":[]}", ENDITEM,
		...
		"Name=templateQueries[0].template", "Value={TemplateId}", ENDITEM,
		...
		"Name=schedulerTime", "Value={Sch_Date} {Sch_Time1}", ENDITEM,
		"Name=scheduleDateJSON", "Value={\"startDateTime\":\"{Sch_Date}T{Sch_Time2}Z\",\"timeZone\":{\"text\":\"(GMT +00:00) UTC\\n"
		...
		"Name=_csrf", "Value={CsrfId2}", ENDITEM,
		LAST);
	...
	web_url("{User_Id}_3", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1591942016896", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/executionStatus/list", 
		"Snapshot=t150.inf", 
