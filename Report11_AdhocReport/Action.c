Action()
{
	...
	lr_start_transaction("Rep11_T01_OpenApplication");
...
/*Correlation comment - Do not change!  Original value='06a8817d-c662-46c5-90f6-496bfa64a5e6' Name ='CsrfTokenId1' Type ='Manual'*/
	...
	lr_end_transaction("Rep11_T01_OpenApplication",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep11_T02_Login");
...
/*Correlation comment - Do not change!  Original value='20c4e0c6-e16b-44f4-b559-e9c057111ac8' Name ='CsrfTokenId2' Type ='Manual'*/
	web_reg_save_param_ex(
...
//		"{URL}");
	...
	web_url("{User_Id}", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1592376326798", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/dashboard/index", 
		"Snapshot=t49.inf", 
...
//		"XMLHttpRequest");
	...
	web_url("dataTables_en.json", 
		"URL={URL}/reports/assets/i18n/dataTables_en.json?_=1592376326799", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/dashboard/index", 
		"Snapshot=t55.inf", 
	...
	web_url("dataTables_en.json_2", 
		"URL={URL}/reports/assets/i18n/dataTables_en.json?_=1592376326800", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/dashboard/index", 
		"Snapshot=t56.inf", 
	...
	lr_end_transaction("Rep11_T02_Login",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep11_T03_NavigateAdhocReport_NewReport");
...
//		"application/json, text/javascript, */*; q=0.01");
	...
	web_url("{User_Id}_2", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1592376376358", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t96.inf", 
...
//	web_revert_auto_header("X-Requested-With");
	...
	lr_end_transaction("Rep11_T03_NavigateAdhocReport_NewReport",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep11_T04_ClickProductLookUp");

	lr_end_transaction("Rep11_T04_ClickProductLookUp",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep11_T05_SearchProduct");
	...
	web_custom_request("getSelectedItem", 
		"URL={URL}/reports/productDictionary/getSelectedItem?productId={ProductId}&dataSource=pva&dictionaryLevel=1&currentLang=en", 
		"Method=POST", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
	...
	lr_end_transaction("Rep11_T05_SearchProduct",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep11_T06_SelectProduct");

	lr_end_transaction("Rep11_T06_SelectProduct",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep11_T07_SelectReportTemplate");
	...
	web_url("keep-alive", 
		"URL={URL}/reports/keep-alive?_=1592376376359", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t118.inf", 
	...
	web_url("getTemplateList", 
		"URL={URL}/reports/reportTemplateRest/getTemplateList?term=&page=1&max=30&oldSelectedValue=&_=1592376376360", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t119.inf", 
	...
	web_url("getTemplateList_2", 
		"URL={URL}/reports/reportTemplateRest/getTemplateList?term=Narrative+Listing&page=1&max=30&oldSelectedValue=&_=1592376376361", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t120.inf", 
	...
	web_url("customSQLValuesForTemplate", 
		"URL={URL}/reports/template/customSQLValuesForTemplate?templateId={TemplateId}&_=1592376376362", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t121.inf", 
	...
	web_url("poiInputsForTemplate", 
		"URL={URL}/reports/template/poiInputsForTemplate?templateId={TemplateId}&_=1592376376363", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t122.inf", 
	...
	lr_end_transaction("Rep11_T07_SelectReportTemplate",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep11_T08_SelectReportQuery");

	web_url("getQueryList", 
		"URL={URL}/reports/queryRest/getQueryList?isQueryTargetReports=true&term=&page=1&max=30&oldSelectedValue=&_=1592376376364", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t123.inf", 
	...
	web_url("getQueryList_2", 
		"URL={URL}/reports/queryRest/getQueryList?isQueryTargetReports=true&term=Fatal+and+LT+cases&page=1&max=30&oldSelectedValue=&_=1592376376365", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t124.inf", 
	...
	web_url("queryExpressionValuesForQuery", 
		"URL={URL}/reports/query/queryExpressionValuesForQuery?queryId={QueryId}&_=1592376376366", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t125.inf", 
	...
	web_url("customSQLValuesForQuery", 
		"URL={URL}/reports/query/customSQLValuesForQuery?queryId={QueryId}&_=1592376376367", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t126.inf", 
	...
	web_url("queryExpressionValuesForQuerySet", 
		"URL={URL}/reports/query/queryExpressionValuesForQuerySet?queryId={QueryId}&_=1592376376368", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t127.inf", 
	...
	web_url("reportFieldsForQueryValue", 
		"URL={URL}/reports/queryRest/reportFieldsForQueryValue?name=masterPbrerBucket&_=1592376376369", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t128.inf", 
	...
	web_url("possibleValues", 
		"URL={URL}/reports/query/possibleValues?lang=en&field=masterPbrerBucket&_=1592376376370", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t129.inf", 
	...
	web_url("possibleValues_2", 
		"URL={URL}/reports/query/possibleValues?lang=en&field=masterPbrerBucket&_=1592376376371", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t130.inf", 
	...
	lr_end_transaction("Rep11_T08_SelectReportQuery",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep11_T09_SaveAndRun");
	...
	web_submit_data("run",
		...
		"Name=asOfVersionDate", "Value={AsOfVersionDate}", ENDITEM,
	...
	web_url("{User_Id}_3", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1592376558568", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/executionStatus/list", 
		"Snapshot=t144.inf", 
	...
	web_url("executionStatus", 
		...
		"columns%5B10%5D%5Bsearch%5D%5Bregex%5D=false&order%5B0%5D%5Bcolumn%5D=5&order%5B0%5D%5Bdir%5D=desc&start=0&length=50&search%5Bvalue%5D=&search%5Bregex%5D=false&tableFilter=%7B%7D&advancedFilter=false&sharedwith=&searchString=&direction=desc&sort=runDate&status=GENERATING&_=1592376558569", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/executionStatus/list", 
		"Snapshot=t145.inf", 
	...
	lr_end_transaction("Rep11_T09_SaveAndRun",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep11_T10_Logout");
	...
	lr_end_transaction("Rep11_T10_Logout",LR_AUTO);
