# 1 "c:\\project\\pvr\\scripts\\newscenarios\\report13_adhocreport\\\\combined_Report13_AdhocReport.c"
...
# 1 "c:\\project\\pvr\\scripts\\newscenarios\\report13_adhocreport\\\\combined_Report13_AdhocReport.c" 2
...
Action()
{
	...
	lr_end_transaction("Rep13_T01_OpenApplication",2);
	...
	web_submit_data("authenticate",
		...
		"Name=_csrf", "Value={CsrfTokoenId_1}", "ENDITEM",
		"LAST");
	...
	web_url("{User_Id}", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1591963447231", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/dashboard/index", 
		"Snapshot=t50.inf", 
	...
	web_url("dataTables_en.json", 
		"URL={URL}/reports/assets/i18n/dataTables_en.json?_=1591963447233", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/dashboard/index", 
		"Snapshot=t54.inf", 
	...
	web_url("latestPeriodicReport", 
		"URL={URL}/reports/periodicReportConfigurationRest/latestPeriodicReport?length=4&start=0&_=1591963447232", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/dashboard/index", 
		"Snapshot=t55.inf", 
	...
	web_url("dataTables_en.json_2", 
		"URL={URL}/reports/assets/i18n/dataTables_en.json?_=1591963447234", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/dashboard/index", 
		"Snapshot=t56.inf", 
	...
	lr_end_transaction("Rep13_T02_Login",2);
	...
	web_url("{User_Id}_2", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1591963472778", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t97.inf", 
	...
	lr_end_transaction("Rep13_T03_NavigateAdhocReport_NewReport",2);

	lr_think_time(3);

	lr_start_transaction("Rep13_T04_ClickProductLookUp");

	lr_end_transaction("Rep13_T04_ClickProductLookUp",2);
	...
	lr_end_transaction("Rep13_T05_SearchProduct",2);
	...
	lr_end_transaction("Rep13_T06_SelectProduct",2);
	...
	web_url("getTemplateList", 
		"URL={URL}/reports/reportTemplateRest/getTemplateList?term=&page=1&max=30&oldSelectedValue=&_=1591963472780", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t121.inf", 
	...
	web_url("getTemplateList_2", 
		"URL={URL}/reports/reportTemplateRest/getTemplateList?term=Case+Compliance+Listing&page=1&max=30&oldSelectedValue=&_=1591963472781", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t122.inf", 
	...
	web_url("customSQLValuesForTemplate", 
		"URL={URL}/reports/template/customSQLValuesForTemplate?templateId={TemplateId}&_=1591963472782", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t123.inf", 
	...
	web_url("poiInputsForTemplate", 
		"URL={URL}/reports/template/poiInputsForTemplate?templateId={TemplateId}&_=1591963472783", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t124.inf", 
	...
	lr_end_transaction("Rep13_T07_SelectReportTemplate",2);
	...
	web_url("getQueryList", 
		"URL={URL}/reports/queryRest/getQueryList?isQueryTargetReports=true&term=&page=1&max=30&oldSelectedValue=&_=1591963472784", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t125.inf", 
	...
	web_url("getQueryList_2", 
		"URL={URL}/reports/queryRest/getQueryList?isQueryTargetReports=true&term=Late+Reports&page=1&max=30&oldSelectedValue=&_=1591963472785", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t126.inf", 
	...
	web_url("queryExpressionValuesForQuery", 
		"URL={URL}/reports/query/queryExpressionValuesForQuery?queryId={QueryId}&_=1591963472786", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t127.inf", 
	...
	web_url("customSQLValuesForQuery", 
		"URL={URL}/reports/query/customSQLValuesForQuery?queryId={QueryId}&_=1591963472787", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t128.inf", 
	...
	web_url("queryExpressionValuesForQuerySet", 
		"URL={URL}/reports/query/queryExpressionValuesForQuerySet?queryId={QueryId}&_=1591963472788", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t129.inf", 
	...
	lr_end_transaction("Rep13_T08_SelectReportQuery",2);
	...
	web_submit_data("run",
		...
		"Name=productSelection", "Value={\"1\":[{\"name\":\"{ProductName}\",\"id\":\"{Product_Id}\"}],\"2\":[],\"3\":[],\"4\":[]}", "ENDITEM", 
		...
		"Name=scheduleDateJSON", "Value={\"startDateTime\":\"{SchDate}T{SchTime_2}Z\",\"timeZone\":{\"text\":\"(GMT +00:00) UTC\\n"
	...
	web_url("{User_Id}_3", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1591963746717", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/executionStatus/list", 
		"Snapshot=t144.inf", 
	...
	lr_end_transaction("Rep13_T09_SaveAndRun",2);
	...
	lr_end_transaction("Rep13_T10_Logout",2);
