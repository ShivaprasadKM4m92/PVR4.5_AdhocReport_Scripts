# 1 "c:\\project\\pvr\\scripts\\newscenarios\\report9_adhocreport\\\\combined_Report9_AdhocReport.c"
...
# 1 "c:\\project\\pvr\\scripts\\newscenarios\\report9_adhocreport\\\\combined_Report9_AdhocReport.c" 2
...
Action()
{
	...
	lr_end_transaction("Rep9_T01_OpenApplication",2);
	...
	lr_end_transaction("Rep9_T02_Login",2);
	...
	lr_end_transaction("Rep9_T03_NavigateAdhocReport_NewReport",2);

	lr_think_time(3);

	lr_start_transaction("Rep9_T04_ClickProductLookUp");

	lr_end_transaction("Rep9_T04_ClickProductLookUp",2);
	...
	lr_end_transaction("Rep9_T05_SearchProduct",2);
	...
	lr_end_transaction("Rep9_T06_SelectProduct",2);
	...
	lr_end_transaction("Rep9_T07_SelectReportTemplate",2);
	...
	lr_end_transaction("Rep9_T08_SelectReportQuery",2);
	...
	lr_end_transaction("Rep9_T09_SaveAndRun",2);
	...
	lr_end_transaction("Rep9_T10_Logout",2);
