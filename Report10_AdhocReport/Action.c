Action()
{
	...
	lr_start_transaction("Rep10_T01_OpenApplication");
...
/*Correlation comment - Do not change!  Original value='c30e0254-91f4-47e1-b9f0-61b2058381bf' Name ='CsrfTokenId1' Type ='Manual'*/
	...
	lr_end_transaction("Rep10_T01_OpenApplication",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep10_T02_Login");
...
/*Correlation comment - Do not change!  Original value='e34b0d2f-a836-446d-9007-b02c1773e65e' Name ='CsrfTokenId2' Type ='Manual'*/
	web_reg_save_param_ex(
...
//		"application/json, text/javascript, */*; q=0.01");
	...
	web_url("{User_Id}", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1591947932004", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/dashboard/index", 
		"Snapshot=t47.inf", 
...
//
//	web_url("websocket", 
//		"URL={URL}/reports/stomp/091/sbxq966s/websocket", 
//		"Resource=0", 
//		"Referer=", 
//		"Snapshot=t56.inf", 
//		"Mode=HTTP", 
//		LAST);
	...
	lr_end_transaction("Rep10_T02_Login",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep10_T03_NavigateAdhocReport_NewReport");
...
//		"XMLHttpRequest");
	...
	web_url("{User_Id}_2", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1591947978807", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t98.inf", 
...
//		"*/*");
	...
	web_url("websocket_2", 
		"URL={URL}/reports/stomp/575/822fu55g/websocket", 
		"Resource=0", 
		"Referer=", 
		"Snapshot=t114.inf", 
		"Mode=HTTP", 
	...
	lr_end_transaction("Rep10_T03_NavigateAdhocReport_NewReport",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep10_T04_ClickProductLookUp");

	lr_end_transaction("Rep10_T04_ClickProductLookUp",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep10_T05_SearchProduct");
	...
	lr_end_transaction("Rep10_T05_SearchProduct",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep10_T06_SelectProduct");
	...
	lr_end_transaction("Rep10_T06_SelectProduct",LR_AUTO);
	...
	web_url("keep-alive", 
		"URL={URL}/reports/keep-alive?_=1591947978808", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t121.inf", 
	...
	lr_start_transaction("Rep10_T07_SelectReportTemplate");

	web_add_auto_header("Accept", 
		"application/json, text/javascript, */*; q=0.01");

	web_url("getTemplateList", 
		"URL={URL}/reports/reportTemplateRest/getTemplateList?term=&page=1&max=30&oldSelectedValue=&_=1591947978809", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t122.inf", 
	...
	web_url("getTemplateList_2", 
		"URL={URL}/reports/reportTemplateRest/getTemplateList?term=Lot+by+SOC&page=1&max=30&oldSelectedValue=&_=1591947978810", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t123.inf", 
	...
	web_url("customSQLValuesForTemplate", 
		"URL={URL}/reports/template/customSQLValuesForTemplate?templateId={TemplateId}&_=1591947978811", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t124.inf", 
	...
	web_url("poiInputsForTemplate", 
		"URL={URL}/reports/template/poiInputsForTemplate?templateId={TemplateId}&_=1591947978812", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t125.inf", 
	...
	lr_end_transaction("Rep10_T07_SelectReportTemplate",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep10_T08_SelectReportQuery");

	web_url("getQueryList", 
		"URL={URL}/reports/queryRest/getQueryList?isQueryTargetReports=true&term=&page=1&max=30&oldSelectedValue=&_=1591947978813", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t126.inf", 
	...
	web_url("getQueryList_2", 
		"URL={URL}/reports/queryRest/getQueryList?isQueryTargetReports=true&term=Lot+Number&page=1&max=30&oldSelectedValue=&_=1591947978814", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t127.inf", 
	...
	web_url("queryExpressionValuesForQuery", 
		"URL={URL}/reports/query/queryExpressionValuesForQuery?queryId={QueryId}&_=1591947978816", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t128.inf", 
	...
	web_url("keep-alive_2", 
		"URL={URL}/reports/keep-alive?_=1591947978815", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t129.inf", 
	...
	web_url("customSQLValuesForQuery", 
		"URL={URL}/reports/query/customSQLValuesForQuery?queryId={QueryId}&_=1591947978817", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t130.inf", 
	...
	web_url("queryExpressionValuesForQuerySet", 
		"URL={URL}/reports/query/queryExpressionValuesForQuerySet?queryId={QueryId}&_=1591947978818", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t131.inf", 
	...
	web_url("reportFieldsForQueryValue", 
		"URL={URL}/reports/queryRest/reportFieldsForQueryValue?name=doseRegimensPackageId&_=1591947978819", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t132.inf", 
	...
	web_url("reportFieldsForQueryValue_2", 
		"URL={URL}/reports/queryRest/reportFieldsForQueryValue?name=doseRegimensLotNo&_=1591947978820", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t133.inf", 
	...
	web_url("possibleValues", 
		"URL={URL}/reports/query/possibleValues?lang=en&field=doseRegimensPackageId&_=1591947978821", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t134.inf", 
	...
	web_url("possibleValues_2", 
		"URL={URL}/reports/query/possibleValues?lang=en&field=doseRegimensPackageId&_=1591947978822", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t135.inf", 
	...
	web_url("possibleValues_3", 
		"URL={URL}/reports/query/possibleValues?lang=en&field=doseRegimensLotNo&_=1591947978823", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t136.inf", 
	...
	web_url("possibleValues_4", 
		"URL={URL}/reports/query/possibleValues?lang=en&field=doseRegimensLotNo&_=1591947978824", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t137.inf", 
	...
	lr_end_transaction("Rep10_T08_SelectReportQuery",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep10_T09_SaveAndRun");
	...
	web_submit_data("run", 
		...
		"Name=description", "Value={Report_Name}", ENDITEM, 
	...
	web_url("{User_Id}", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1591954324862", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/executionStatus/list", 
		"Snapshot=t6.inf", 
	...
	web_url("executionStatus", 
		...
		"columns%5B10%5D%5Bsearch%5D%5Bregex%5D=false&order%5B0%5D%5Bcolumn%5D=5&order%5B0%5D%5Bdir%5D=desc&start=0&length=50&search%5Bvalue%5D=&search%5Bregex%5D=false&tableFilter=%7B%7D&advancedFilter=false&sharedwith=&searchString=&direction=desc&sort=runDate&status=GENERATING&_=1591954324863", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/executionStatus/list", 
		"Snapshot=t7.inf", 
	...
	lr_end_transaction("Rep10_T09_SaveAndRun",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep10_T10_Logout");
...
//		LAST);
	...
	lr_end_transaction("Rep10_T10_Logout",LR_AUTO);
