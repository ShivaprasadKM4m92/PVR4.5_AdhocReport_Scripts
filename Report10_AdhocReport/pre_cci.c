# 1 "c:\\project\\pvr\\scripts\\newscenarios\\report10_adhocreport\\\\combined_Report10_AdhocReport.c"
...
# 1 "c:\\project\\pvr\\scripts\\newscenarios\\report10_adhocreport\\\\combined_Report10_AdhocReport.c" 2
...
Action()
{
	...
	lr_end_transaction("Rep10_T01_OpenApplication",2);
	...
	lr_end_transaction("Rep10_T02_Login",2);
	...
	lr_end_transaction("Rep10_T03_NavigateAdhocReport_NewReport",2);

	lr_think_time(3);

	lr_start_transaction("Rep10_T04_ClickProductLookUp");

	lr_end_transaction("Rep10_T04_ClickProductLookUp",2);
	...
	lr_end_transaction("Rep10_T05_SearchProduct",2);
	...
	lr_end_transaction("Rep10_T06_SelectProduct",2);
	...
	lr_end_transaction("Rep10_T07_SelectReportTemplate",2);
	...
	lr_end_transaction("Rep10_T08_SelectReportQuery",2);
	...
	lr_end_transaction("Rep10_T09_SaveAndRun",2);
	...
	lr_end_transaction("Rep10_T10_Logout",2);
