# 1 "c:\\project\\pvr\\scripts\\newscenarios\\report4_adhocreport\\\\combined_Report4_AdhocReport.c"
...
# 1 "c:\\project\\pvr\\scripts\\newscenarios\\report4_adhocreport\\\\combined_Report4_AdhocReport.c" 2
...
Action()
{
	...
	lr_end_transaction("Rep4_T01_OpenApplication",2);
	...
	lr_end_transaction("Rep4_T02_Login",2);
	...
	lr_end_transaction("Rep4_T03_NavigateAdhocReport_NewReport",2);

	lr_think_time(3);

	lr_start_transaction("Rep4_T04_ClickProductLookUp");

	lr_end_transaction("Rep4_T04_ClickProductLookUp",2);
	...
	lr_end_transaction("Rep4_T05_SearchProduct",2);
	...
	lr_end_transaction("Rep4_T06_SelectProduct",2);
	...
	lr_end_transaction("Rep4_T07_SelectReportTemplate",2);
	...
	lr_end_transaction("Rep4_T08_SelectReportQuery",2);
	...
	lr_end_transaction("Rep4_T09_SelectDateRange(1Year)",2);
	...
	lr_end_transaction("Rep4_T10_SaveAndRun",2);
	...
	lr_end_transaction("Rep4_T11_Logout",2);
