Action()
{
	...
	lr_start_transaction("Rep4_T01_OpenApplication");
...
/*Correlation comment - Do not change!  Original value='2fed9324-e590-4878-9188-13b3e6a9ff9d' Name ='CsrfId1' Type ='Manual'*/
	...
	lr_end_transaction("Rep4_T01_OpenApplication",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep4_T02_Login");
...
//		LAST);
	...
	lr_end_transaction("Rep4_T02_Login",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep4_T03_NavigateAdhocReport_NewReport");
...
//		"*/*");
	...
	lr_end_transaction("Rep4_T03_NavigateAdhocReport_NewReport",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep4_T04_ClickProductLookUp");

	lr_end_transaction("Rep4_T04_ClickProductLookUp",LR_AUTO);

	lr_think_time(3);
	
	lr_start_transaction("Rep4_T05_SearchProduct");
	...
	lr_end_transaction("Rep4_T05_SearchProduct",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep4_T06_SelectProduct");
	...
	lr_end_transaction("Rep4_T06_SelectProduct",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep4_T07_SelectReportTemplate");
...
//		LAST);
	...
	lr_end_transaction("Rep4_T07_SelectReportTemplate",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep4_T08_SelectReportQuery");
	...
	lr_end_transaction("Rep4_T08_SelectReportQuery",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep4_T09_SelectDateRange(1Year)");
...
//		LAST);
	...
	lr_end_transaction("Rep4_T09_SelectDateRange(1Year)",LR_AUTO);
...
//		LAST);
	...
	lr_start_transaction("Rep4_T10_SaveAndRun");
	...
	web_url("{User_Id}", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1592205914326", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/executionStatus/list", 
		"Snapshot=t7.inf", 
	...
	web_url("executionStatus", 
		...
		"columns%5B10%5D%5Bsearch%5D%5Bregex%5D=false&order%5B0%5D%5Bcolumn%5D=5&order%5B0%5D%5Bdir%5D=desc&start=0&length=50&search%5Bvalue%5D=&search%5Bregex%5D=false&tableFilter=%7B%7D&advancedFilter=false&sharedwith=&searchString=&direction=desc&sort=runDate&status=GENERATING&_=1592205914327", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/executionStatus/list", 
		"Snapshot=t8.inf", 
	...
	lr_end_transaction("Rep4_T10_SaveAndRun",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("Rep4_T11_Logout");
	...
	lr_end_transaction("Rep4_T11_Logout",LR_AUTO);
