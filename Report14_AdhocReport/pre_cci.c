# 1 "c:\\project\\pvr\\scripts\\newscenarios\\report14_adhocreport\\\\combined_Report14_AdhocReport.c"
...
# 1 "c:\\project\\pvr\\scripts\\newscenarios\\report14_adhocreport\\\\combined_Report14_AdhocReport.c" 2
...
Action()
{
	...
	lr_end_transaction("Rep14_T01_OpenApplication",2);
	...
	lr_end_transaction("Rep14_T02_Login",2);
	...
	lr_end_transaction("Rep14_T03_NavigateAdhocReport_NewReport",2);

	lr_think_time(3);

	lr_start_transaction("Rep14_T04_ClickProductLookUp");

	lr_end_transaction("Rep14_T04_ClickProductLookUp",2);
	...
	lr_end_transaction("Rep14_T05_SearchProduct",2);
	...
	lr_end_transaction("Rep14_T06_SelectProduct",2);
	...
	lr_end_transaction("Rep14_T07_SelectReportTemplate",2);
	...
	lr_end_transaction("Rep14_T08_SelectReportQuery",2);
	...
	lr_end_transaction("Rep14_T09_SaveAndRun",2);
	...
	lr_end_transaction("Rep14_T10_Logout",2);
